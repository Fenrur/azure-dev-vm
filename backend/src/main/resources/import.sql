...
INSERT INTO users (id, username, password, role, token) VALUES
    ...
    (0, 'livio', '$2a$10$XyI4MSVsuScHCFuk3ZNZcOpzKZlKiAMGFvAPcROrjYfEdG2qswE6i', 'advanced', 0),
    (1, 'abou', '$2a$10$OYckHMAEKSiGh24bNMznvuSWPFdKF94i0hlTQps7y9AVRLxX7.f6G', 'basic', 0),
